...
#example-1 
var1 = True #assignment
var2 = var1 #assignment of value of var1 to var2
print(var1,var2)

#python extra - we can declare multiple variables and assign them values respectively at the same time
var1, var2 = 70, 80
print(var1,var2)

#python extra - we can swap the value of 2 variables by assigning each variable alternatively to each other
var1,var2=var2,var1
print(var1,var2)
